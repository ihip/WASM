...
var wasmBinaryFile = 'stolnjak.wasm';
...
var ASM_CONSTS = [function($0, $1, $2, $3) { var g = Module.canvas.getContext('2d'); g.strokeStyle = 'red'; g.moveTo($0, $1); g.lineTo($2, $3); g.stroke(); }];
